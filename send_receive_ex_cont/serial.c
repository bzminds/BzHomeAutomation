...
/*************************************************************************/
/* Receiving string continuous from the serial port until end arrives    */
/*-----------------------------------------------------------------------*/
/* INPUT                                                                 */
/*   -serial_fd: Serial device descriptor                                */ 
/*   -timeout_usec: Timeout time (in micro-secs) for receiving the data  */
...
/*   -0 if none received. It means a TIMEOUT!                            */
/*************************************************************************/
int serial_read_cont(int serial_fd, char *data, int timeout_usec)
{
  fd_set fds;
  struct timeval timeout;
  int count=0;
